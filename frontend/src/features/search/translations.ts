...
const englishSearch = {
    ...
    clearViewedProducts: "Clear viewed Products",
    ...
    removeProductFromViewedProducts:
        "Remove Product {{barcode}} from viewed Products",
...
const khmerSearch: SearchTranslations = {
    ...
    seeAll: "មើលទាំងអស់",
    clearAll: "លុបទាំងអស់",
    clearRecentSearches: "លុបការស្វែងរកថ្មីៗទាំងអស់",
    clearViewedProducts: "លុបផលិតផលដែលបានមើលទាំងអស់",
    ...
    product: "ផលិតផល",
    removeProductFromViewedProducts:
        "លុបផលិតផល {{barcode}} ចេញពីផលិតផលដែលបានមើល",
    startSearchHistory: "ស្វែងរកផលិតផល ដើម្បីចាប់ផ្តើមប្រវត្តិរបស់អ្នក។",
    noRecentSearches: "ការស្វែងរកថ្មីៗរបស់អ្នកនឹងបង្ហាញនៅទីនេះ។",
