...
const englishProduct = {
    ...
    barcodeNotInSnapshot:
        "Barcode {{barcode}} does not exist in the active local Open Food Facts snapshot.",
    snapshotOnlyProducts:
    ...
    barcodeNotInSnapshotPrefix: "Barcode",
    barcodeNotInSnapshotSuffix:
        "does not exist in the active local Open Food Facts snapshot.",
    ...
    openFoodFactsDeclarations: "Open Food Facts declarations",
    ...
    openFoodFactsTraces: "Open Food Facts traces",
    ingredientWordingEvidence: "Ingredient and wording evidence",
    item: "item",
    items: "items",
    noAllergenTags:
        "No allergen or trace tags are available from Open Food Facts.",
    ingredientMatches: "Ingredient matches",
    foundThrough: "Found through “{{text}}” in the ingredient text.",
...
const khmerProduct: ProductTranslations = {
    ...
    barcodeNotInSnapshot:
        "បាកូដ {{barcode}} មិនមានក្នុង Open Food Facts Snapshot មូលដ្ឋានដែលកំពុងប្រើទេ។",
    snapshotOnlyProducts:
    ...
    barcodeNotInSnapshotPrefix: "បាកូដ",
    barcodeNotInSnapshotSuffix:
        "មិនមានក្នុង Open Food Facts Snapshot មូលដ្ឋានដែលកំពុងប្រើទេ។",
    ...
    barcode: "បាកូដ",
    quantity: "បរិមាណ",
    barcodeCountry: "ប្រទេសតាមបាកូដ",
    openImage: "បើករូបភាពផលិតផល",
    photoAttribution: "ប្រភពរូបភាព",
    sourceAssessments: "ការវាយតម្លៃពីប្រភព",
    sourceAssessmentsDescription:
        "ការគណនារបស់ Open Food Facts; មិនមែនជាការវិនិច្ឆ័យរបស់ Life Goods ឬការណែនាំឱ្យទិញទេ។",
    openFoodFactsSourceAssessments: "ការវាយតម្លៃពីប្រភព Open Food Facts",
    ...
    sourcePackageLabel: "ប្រភព៖ ការបញ្ជាក់លើស្លាកកញ្ចប់",
    showSourceEvidence: "បង្ហាញភស្តុតាងប្រភព",
    hideSourceEvidence: "លាក់ភស្តុតាងប្រភព",
    viewIngredientEvidence: "មើលភស្តុតាងគ្រឿងផ្សំ",
    viewWordingAndSourceContext: "មើលពាក្យ និងបរិបទប្រភព",
    ...
    openFoodFactsDeclarations: "ការប្រកាសរបស់ Open Food Facts",
    ...
    nutritionSource:
        "ប្រភព៖ តារាងព័ត៌មានអាហារូបត្ថម្ភដែលបានចម្លងពីកញ្ចប់ផលិតផលជាក់ស្តែង។",
    ...
    dataSourceCitation: "ប្រភពទិន្នន័យ និងការដកស្រង់",
    ...
    openFoodFactsTraces: "ដានសារធាតុរបស់ Open Food Facts",
    ingredientWordingEvidence: "ភស្តុតាងគ្រឿងផ្សំ និងពាក្យពេចន៍",
    item: "មុខ",
    items: "មុខ",
    noAllergenTags: "មិនមានស្លាកអាលែហ្ស៊ី ឬដានសារធាតុពី Open Food Facts ទេ។",
    ingredientMatches: "ការផ្គូផ្គងគ្រឿងផ្សំ",
    foundThrough: "រកឃើញតាមរយៈ “{{text}}” ក្នុងអត្ថបទគ្រឿងផ្សំ។",
    mayContain: "អាចមាន",
    ...
    sourceImageUnavailable: "មិនមានរូបភាពប្រភព",
    close: "បិទ",
    openFoodFactsLogo: "ឡូហ្គោ Open Food Facts",
    sourceAnalysisDisclaimer:
        "ការវិភាគពីប្រភព Open Food Facts; មិនមែនជាការវិនិច្ឆ័យរបស់ Life Goods ទេ។",
    level: "កម្រិត៖ {{value}}",
    ...
    total: "សរុប",
    noPackagePhotographs: "មិនមានរូបថតកញ្ចប់រក្សាទុកក្នុងកំណត់ត្រាប្រភពទេ។",
