...
export const CountryTagInfoCard: React.FC<CountryTagInfoCardProps> = ({
    ...
    return (
        <Card className="border-info-200/90 bg-info-50/90 text-info-950 shadow-none">
            <CardHeader className="flex flex-row items-start gap-2 p-4 pb-2 sm:p-5 sm:pb-2">
            ...
            <CardContent className="text-info-900 space-y-2 p-4 pt-1 text-xs leading-relaxed sm:p-5 sm:pt-1">
