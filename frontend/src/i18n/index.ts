...
export const resources = {
  km: {
    translation: {
      ...
      fieldLabel: 'លេខបាកូដ',
      fieldHint: 'គាំទ្រលេខ GTIN, EAN និង UPC ដែលមាន ៨, ១២, ១៣ ឬ ១៤ ខ្ទង់។',
      submit: 'ពិនិត្យបាកូដ',
      ...
      matchBody: 'មាន Package Match មួយ ប៉ុន្តែព័ត៌មានលម្អិតមិនទាន់មាននៅក្នុងផ្នែកនេះទេ។',
      failureTitle: 'មិនអាចពិនិត្យបានឥឡូវនេះ',
      failureBody: 'សេវាមិនអាចពិនិត្យបាកូដនេះបានឥឡូវនេះទេ។ សូមព្យាយាមម្ដងទៀត។',
  ...
  en: {
    translation: {
      ...
      guidance: 'Enter the digits printed below the barcode. Spaces and hyphens are okay.',
      fieldLabel: 'Barcode number',
      fieldHint: 'Supports 8, 12, 13, and 14-digit GTIN, EAN, and UPC identifiers.',
      ...
      matchBody: 'A Package Match exists, but its details are not included in this slice.',
      failureTitle: 'Could not check right now',
      failureBody: 'The service could not check this barcode right now. Please try again.',
      retry: 'Retry',
      tryAnother: 'Try another barcode',
      identifierLabel: 'Checked barcode',
      error: {
        required: 'Enter a barcode number.',
        characters: 'A barcode may contain only digits, spaces, or hyphens.',
