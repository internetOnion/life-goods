...
export function PlaceholderPage({ kind }: PlaceholderPageProps) {
    ...
    return (
        <main className="mx-auto w-[min(calc(100%_-_2rem),48rem)] pt-[clamp(3rem,12vh,7rem)] pb-[calc(6.4rem_+_env(safe-area-inset-bottom))] max-[23.5rem]:w-[min(calc(100%_-_1.25rem),48rem)] sm:w-[min(calc(100%_-_3rem),48rem)]">
            <h1
